...
class ModelEncodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEncodedModel = channel.unary_unary(
                ...
                request_serializer=proto_dot_service_dot_service__pb2.Request.SerializeToString,
                response_deserializer=proto_dot_service_dot_service__pb2.ModelResponse.FromString,
                )
...
def add_ModelEncodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEncodedModel': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_service_dot_service__pb2.Request.FromString,
                    response_serializer=proto_dot_service_dot_service__pb2.ModelResponse.SerializeToString,
            ),
    }
...
class ModelEncode(object):
    ...
    def GetEncodedModel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/service.ModelEncode/GetEncodedModel',
            proto_dot_service_dot_service__pb2.Request.SerializeToString,
            proto_dot_service_dot_service__pb2.ModelResponse.FromString,
